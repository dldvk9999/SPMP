# Security Program Management Program
- 보안프로그램들을 한번에 최적화 시켜주는 프로그램입니다.
- 본 프로그램의 악용은 절대 금물이며 보안 프로그램 강제 삭제하는 프로그램이 절대 아님을 알려드립니다.
<br>
- 사용법.<br>
...
6. "START-vaccine.bat"를 클릭했을 시 탐지 된 파일이 1개이어야 정상입니다.<br>
